...
<form action="" method="post">
   ...
   <div class="user-info">
      ...
      <input type="submit" value="cash on delivery" class="btn <?php if($fetch_profile['address'] == ''){echo 'disabled';} ?>" style="width:100%; background:var(--red); color:var(--white);" name="submit">
      <a href="payment.php" value= "online" class = "btn<?php if($fetch_profile['address'] == ''){echo 'disabled';} ?>" style="width:100%; background:var(--red); color:var(--white); text-align:center" name="submit">online payment</a>
   </div>
